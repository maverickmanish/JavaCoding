...
public class Check {
    ...
    public static void main(String[] args) {
        ...
        list.stream().sorted(Comparator.comparing(Employee::getAddress, Comparator.comparing(Address::getCity))).forEach(System.out::println);
        list.forEach(System.out::println);
    ...
    public static String jsonString() {
        return "{\"studentId\": 1001, \"studentName\": \"Rajesh\","
